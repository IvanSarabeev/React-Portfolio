    ...
    <>
      ...
      >
        <div className="relative flex flex-col rounded-xl p-6 hover:ring-2 hover:ring-neutral-400/30">
          <h3 className="my-2 break-words font-paragraph text-sm italic leading-4 text-[#2686976] md:text-base">
            {edu.year}
          </h3>
          <h4 className="mt-3 font-pageheading text-lg font-semibold capitalize sm:text-xl md:mt-2 md:text-[22px]">
            {edu.title}
          </h4>
          <h5 className="my-2 font-paragraph leading-6 text-[#2686976] md:leading-8">
            {edu.establishment}
          </h5>
          <img
            src={edu.icon}
