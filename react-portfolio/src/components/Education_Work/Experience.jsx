  ...
  return (
    ...
    >
      <div className="relative flex flex-col rounded-xl p-6 hover:ring-2 hover:ring-neutral-400/30">
        <h4 className="my-2 break-words text-sm italic leading-4 text-[#2686976] md:text-base">
          {exp.period}
        </h4>
        <h3 className="mt-3 text-lg font-semibold capitalize sm:text-xl md:mt-2 md:text-[22px]">
          {exp.company}
        </h3>
